...
const headCells = [
    { id: 'unitName', numeric: false, disablePadding: true, label: 'Unit Name' },
    { id: 'type', numeric: true, disablePadding: false, label: 'Type' },
    { id: 'referenceCode', numeric: true, disablePadding: false, label: 'Reference Code' },
    { id: 'quantity', numeric: true, disablePadding: false, label: 'Quantity' },
    { id: 'parameters', numeric: true, disablePadding: false, label: 'Parameters' },
    { id: 'storageLocation', numeric: true, disablePadding: false, label: 'Storage Location' },
];
...
export default function EnhancedTable() {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelecteds = rows.map((n) => n.unitName);
    ...
    const isSelected = (unitName) => selected.indexOf(unitName) !== -1;
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.parameters}</TableCell>
